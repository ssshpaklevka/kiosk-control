...
export const ButtonMenuAdvertising = () => {
  ...
  return (
    <div className="flex flex-row gap-8">
      <div className="flex flex-col gap-2">
        <p className="text-xl">Реклама снизу</p>
        ...
        >
          <div className="w-full flex items-end h-full rounded-3xl">
            <div
              ...
              className="w-[259px] h-[33px] ml-[104px] mb-[54px] bg-red-600 rounded-xl bg-cover bg-center bg-no-repeat"
            ></div>
          </div>
      ...
      <div className="flex flex-col gap-4 min-w-80">
        <div>
          <p className="text-lg font-medium mb-2">Изменить рекламу снизу</p>
