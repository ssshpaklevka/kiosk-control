...
import {
  useDeleteBannerLoyality,
  useGetBannersLoyality,
  useUpdateBannerLoyality,
} from "../../hooks/use-banner-loyality";
...
export const TableLoyalAdvertising = () => {
  const { data: banners } = useGetBannersLoyality();
  const { mutate: updateBanner } = useUpdateBannerLoyality();
  const { mutate: deleteBanner } = useDeleteBannerLoyality();
